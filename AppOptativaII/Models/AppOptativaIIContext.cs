...
namespace AppOptativaII.Models
{
    public class AppOptativaIIContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<AppOptativaII.Models.AppOptativaIIContext>());

        public AppOptativaIIContext() : base("name=AppOptativaIIContext")
        {
        }
